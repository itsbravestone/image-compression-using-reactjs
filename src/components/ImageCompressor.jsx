...
export default class imageCompressor extends React.Component {
  constructor() {
    ...
    this.state = {
      compressedLink:
        "https://media.discordapp.net/attachments/866208970738106368/871712921535787008/placeholder.png",
      originalImage: "",
      originalLink: "",
      clicked: false,
      uploadImage: false
          ...
          <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
            {this.state.uploadImage ? (
              ...
              <Card.Img
                className="ht"
                variant="top"
                src="https://media.discordapp.net/attachments/866208970738106368/871712921535787008/placeholder.png"
              ></Card.Img>
            )}
